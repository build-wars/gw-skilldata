...
use const Buildwars\GWSkillDataTools\SRCDIR;
use const Buildwars\GWSkillDataTools\CONST_ATTRIBUTE;
use const Buildwars\GWSkillDataTools\CONST_CAMPAIGN;
use const Buildwars\GWSkillDataTools\CONST_LANG;
use const Buildwars\GWSkillDataTools\CONST_PROFESSION;
use const Buildwars\GWSkillDataTools\CONST_TYPE;
...
abstract class BuilderAbstract implements BuilderInterface{
	...
	protected function createDataClass(array $skillData):static{
		...
		foreach($skillData as $skillID => $data){
			foreach($data as $key => &$field){
				...
				$field = match($key){
					Skill::DATA_ATTRIBUTE  => CONST_ATTRIBUTE[$field],
					Skill::DATA_CAMPAIGN   => CONST_CAMPAIGN[$field],
					Skill::DATA_PROFESSION => CONST_PROFESSION[$field],
					Skill::DATA_TYPE       => CONST_TYPE[$field],
	...
	protected function createLangClass(array $skillDesc, string $langID):static{
		...
		$content = [
			...
			sprintf('public const string LANG = %s;', CONST_LANG[$langID]),
